class ip:
	def __init__(self, ipaddr):
		if ipaddr.__class__ == str:
			print "Is string"
			#TODO detect if ipv4 or ipv6 and convert to long which becomes self.ip
	...
	def bprint(self):
		return 0
		#TODO return string of 1/0's for debugging
	def network(self,mask):
		return 0
		#TODO given a mask return the network, and set the cidr
	def cidr(self, cidr):
		#TODO if given a cidr, return the network, and set the network mask
		return 0
